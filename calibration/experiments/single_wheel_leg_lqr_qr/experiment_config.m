...
cfg.variables = [
    optimizableVariable("log_s_qtheta", [-0.5, 0.5])
    optimizableVariable("log_s_qdtheta", [-0.5, 0.5])
    optimizableVariable("log_s_qx", [-0.5, 0.5])
    optimizableVariable("log_s_qdx", [-0.5, 0.5])
    optimizableVariable("log_s_rfhx", [-0.5, 0.5])
    optimizableVariable("log_s_rmb", [-0.5, 0.5])
    ];
...
cfg.configureScript = fullfile(cfg.simDir, "configure_model.m");
...
cfg.scoreWeights.finalTheta = 120.0;
cfg.scoreWeights.maxAbsTheta = 20.0;
cfg.scoreWeights.dthetaRms = 5.0;
cfg.scoreWeights.finalX = 8.0;
cfg.scoreWeights.maxAbsX = 4.0;
cfg.scoreWeights.tauSaturation = 15.0;
cfg.scoreWeights.uLqrSaturation = 4.0;
