...
%EXPERIMENT_CONFIG Production PD/computed-torque calibration for single_leg.slx.
...
cfg = struct();
cfg.name = "single_leg";
cfg.notes = "Production calibration for the fixed-hip two-link leg computed-torque controller.";
...
cfg.maxObjectiveEvaluations = 100;
