...
s = ...
    ...
    w.finalDtheta * abs(m.finalDtheta) + ...
    ...
    w.postPulsePeakDtheta * finiteValue(m.postPulsePeakAbsDtheta) + ...
    w.thetaZeroDtheta * finiteValue(m.thetaZeroDtheta) + ...
    w.recoveryTauSaturation * finiteValue(m.recoveryTauSaturationRatio) + ...
    w.recoveryULqrSaturation * finiteValue(m.recoveryULqrSaturationRatio);
end

function value = finiteValue(value)
if ~isfinite(value)
    value = 0;
end
end
