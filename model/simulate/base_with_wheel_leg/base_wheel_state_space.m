...
%BASE_WHEEL_STATE_SPACE Linear planar base-plus-wheel-position model.
%
% State: [xB; zB; thetaB; dxB; dzB; dthetaB; xi; dxi]
% Input: [FHx; FHz; MBy], the wheel-leg wrench applied to the base.
...
B(8, 1) = -1 / base.m - leg.r / rollingDenominator;
B(8, 3) = -1 / rollingDenominator;
