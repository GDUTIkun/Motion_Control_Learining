...
%CONFIGURE_MODEL Wire source.slx for hip-PD-to-leg-force validation.
%
% The Rectangular Joint is left dynamically free. A Simulink hip position PD
% computes F_H,des from measured hip x/y motion and passes -F_H,des into the
% leg inverse-dynamics controller as FH_ext.
...
% Controller force-command ports: [FHx_ext; FHy_ext].
...
save_system(model);
fprintf("Configured %s for hip-PD force-command validation.\n", model);
end
